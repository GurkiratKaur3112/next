...
import { Mail, Phone, Github, Linkedin, Twitter, Code, BookOpen, Award, ExternalLink } from "lucide-react"

export const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-black via-slate-950/80 to-black text-white py-16 px-5 border-t border-slate-800">
      <div className="max-w-6xl mx-auto">
        {/* Top Section with Logo and Social Icons */}
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          <div className="flex items-center space-x-3 mb-6 md:mb-0">
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg blur opacity-60 group-hover:opacity-100 transition duration-500"></div>
      ...
      <div className="max-w-6xl mx-auto mt-16 pt-6 border-t border-slate-800">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-slate-400">© {new Date().getFullYear()} AlgoHub. All rights reserved.</p>
